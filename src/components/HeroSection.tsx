      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2 space-y-6">
            <div className="inline-flex items-center gap-2 bg-[#005558]/10 text-[#005558] px-4 py-1.5 rounded-full text-sm font-medium">
              <span className="inline-block w-2 h-2 rounded-full bg-[#005558] animate-pulse" />
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-[#005558] hover:bg-[#005558]/90" asChild>
                <Link to="/signup">
                  Start Free Trial
