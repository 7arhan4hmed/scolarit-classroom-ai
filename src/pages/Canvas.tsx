...
const mockClasses = [
  { id: '1', name: 'Biology 101', students: 35, assignments: 6 },
  { id: '2', name: 'Chemistry', students: 28, assignments: 4 },
  { id: '3', name: 'Physics', students: 22, assignments: 3 },
];
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Your Canvas data has been synchronized.",
      });
    }, 1500);
  };
        ...
        <div className="container mx-auto px-4">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground mt-2">
              Manage your Canvas classes and assignments with SCOLARIT
            </p>
          </div>
          ...
          <Tabs defaultValue="assignments">
            ...
            <TabsContent value="settings">
              <div className="bg-white rounded-lg border shadow-sm p-6">
                <h2 className="text-xl font-semibold mb-4">Canvas Integration Settings</h2>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex items-center p-3 bg-gray-50 border rounded-md">
                      ...
                      />
                      <div>
                        <div className="font-medium">teacher@university.edu</div>
                    ...
                    <div className="space-y-3 p-3 bg-gray-50 border rounded-md">
                      ...
                      <div className="flex items-center justify-between">
                        <label className="font-medium" htmlFor="push-grades">
                          Automatically push grades to Canvas
                        </label>
                        <input 
                          type="checkbox" 
                          id="push-grades" 
