...
const mockClasses = [
  { id: '1', name: 'Psychology 101', students: 45, assignments: 7 },
  { id: '2', name: 'Business Ethics', students: 38, assignments: 5 },
  { id: '3', name: 'Sociology', students: 30, assignments: 6 },
];
...
const BlackboardPage = () => {
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Your Blackboard data has been synchronized.",
      });
    }, 1500);
  };
  ...
  const handleGradeAssignment = (assignmentId: string) => {
    ...
    toast({
      ...
      description: "SCOLARIT AI is now processing student submissions.",
    });
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO title="Blackboard Integration | SCOLARIT" description="Connect SCOLARIT to Blackboard and grade assignments with AI without leaving your LMS." path="/blackboard" />
      <Header />
        ...
        <div className="container mx-auto px-4">
          <div className="mb-6">
            ...
            <div className="flex justify-between items-center">
              <h1 className="text-3xl font-bold">Blackboard Integration</h1>
              <Button 
              ...
              >
                ...
                {isRefreshing ? 'Refreshing...' : 'Sync Courses'}
              </Button>
            </div>
            <p className="text-muted-foreground mt-2">
              Manage your Blackboard courses and assignments with SCOLARIT
            </p>
          </div>
          ...
          <Tabs defaultValue="assignments">
            ...
            <TabsContent value="settings">
              <div className="bg-white rounded-lg border shadow-sm p-6">
                <h2 className="text-xl font-semibold mb-4">Blackboard Integration Settings</h2>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex items-center p-3 bg-gray-50 border rounded-md">
                      ...
                      />
                      <div>
                        <div className="font-medium">instructor@university.edu</div>
                        <div className="text-sm text-muted-foreground">Connected on Apr 7, 2025</div>
                      </div>
                    ...
                    <div className="space-y-3 p-3 bg-gray-50 border rounded-md">
                      <div className="flex items-center justify-between">
                        <label className="font-medium" htmlFor="auto-sync">
                          Auto-sync courses and assignments
                        </label>
                        <input 
                          type="checkbox" 
                          id="auto-sync" 
                          defaultChecked 
                          className="h-5 w-5 rounded border-gray-300 text-blue-600 focus:ring-blue-600/25"
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        <label className="font-medium" htmlFor="push-grades">
                          Automatically push grades to Blackboard
                        </label>
                        <input 
                          type="checkbox" 
                          id="push-grades" 
                  ...
                  <div className="flex justify-end">
                    <Button className="blue-purple-gradient hover:opacity-90">Save Settings</Button>
                  </div>
                </div>
              </div>
            </TabsContent>
