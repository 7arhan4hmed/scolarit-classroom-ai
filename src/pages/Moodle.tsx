...
const mockClasses = [
  { id: '1', name: 'Calculus I', students: 40, assignments: 8 },
  { id: '2', name: 'Computer Science', students: 32, assignments: 6 },
  { id: '3', name: 'Statistics', students: 25, assignments: 4 },
];
...
const MoodlePage = () => {
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Your Moodle data has been synchronized.",
      });
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO title="Moodle Integration | SCOLARIT" description="Integrate SCOLARIT with Moodle to grade assignments faster and return AI-powered feedback to students." path="/moodle" />
      <Header />
        ...
        <div className="container mx-auto px-4">
          <div className="mb-6">
            ...
            <div className="flex justify-between items-center">
              <h1 className="text-3xl font-bold">Moodle Integration</h1>
              <Button 
            ...
            <p className="text-muted-foreground mt-2">
              Manage your Moodle courses and assignments with SCOLARIT
            </p>
          </div>
          ...
          <Tabs defaultValue="assignments">
            ...
            <TabsContent value="settings">
              <div className="bg-white rounded-lg border shadow-sm p-6">
                <h2 className="text-xl font-semibold mb-4">Moodle Integration Settings</h2>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex items-center p-3 bg-gray-50 border rounded-md">
                      ...
                      />
                      <div>
                        <div className="font-medium">professor@college.edu</div>
                    ...
                    <div className="space-y-3 p-3 bg-gray-50 border rounded-md">
                      <div className="flex items-center justify-between">
                        ...
                        <input 
                          ...
                          id="auto-sync" 
                          defaultChecked 
                          className="h-5 w-5 rounded border-gray-300 text-purple-600 focus:ring-purple-600/25"
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        <label className="font-medium" htmlFor="push-grades">
                          Automatically push grades to Moodle
                        </label>
                        <input 
                          type="checkbox" 
                          id="push-grades" 
